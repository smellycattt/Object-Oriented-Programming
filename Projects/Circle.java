...
private 	JLabel		label;
private		boolean		suspendFlag=false;
RightThread(JFrame frame, CircleIcon circle, JLabel label)
{
	this.frame = frame;
	this.circle= circle;
	this.label = label;
...
private 	JLabel		label;
private		boolean		suspendFlag=false;
ScaleUpThread(JFrame frame, CircleIcon circle, JLabel label)
{
	this.frame = frame;
	this.circle= circle;
	this.label = label;
...
private 	JLabel		label;
private		boolean		suspendFlag=false;
ScaleDownThread(JFrame frame, CircleIcon circle, JLabel label)
{
	this.frame = frame;
	this.circle= circle;
	this.label = label;
